...
export default function DashboardSidebar({ role }: { role: UserRole }) {
  ...
  return (
    <aside className="dash-sidebar">
      {/* Logo */}
      <div className="dash-sidebar-logo" style={{ height: 64, display: "flex", alignItems: "center", padding: "0 20px", borderBottom: "1px solid rgba(255,255,255,0.08)", flexShrink: 0 }}>
      ...
      {/* Primary Nav */}
      <nav className="dash-sidebar-main-nav" style={{ flex: 1, padding: "12px 8px", display: "flex", flexDirection: "column", gap: 2, overflowY: "auto" }}>
      ...
      {/* Divider */}
      <div className="dash-sidebar-bottom" style={{ margin: "0 12px", borderTop: "1px solid rgba(255,255,255,0.06)" }} />

      {/* Bottom Nav */}
      <nav className="dash-sidebar-bottom" style={{ padding: "8px", display: "flex", flexDirection: "column", gap: 2 }}>
      ...
      {/* Role badge */}
      <div className="dash-sidebar-role" style={{ padding: "12px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
